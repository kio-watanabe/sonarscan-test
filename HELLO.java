...
public class HELLO implements CobolRunnable {
  ...
  int run_module (int entry) {
    ...
    if (!this.initialized) {
      ...
      b_HELLO.setBytes (str_0_HELLO, 5);
  ...
  public CobolControl[] contList = {
    ...
    new CobolControl(l_MAIN_SECTION__DEFAULT_PARAGRAPH, CobolControl.LabelType.label) {
      public Optional<CobolControl> run() throws CobolRuntimeException, CobolGoBackException, CobolStopRunException {
        /* HELLO.CBL:7: DISPLAY */
        {
          CobolTerminal.display (0, 1, 1, f_HELLO);
        }
        /* HELLO.CBL:8: STOP */
        {
  ...
  public void init()
  {
    try {
      ...
      b_HELLO = new CobolDataStorage(5);	/* HELLO */
      ...
      /* PROGRAM-ID : HELLO */
      f_HELLO	= CobolFieldFactory.makeCobolField(5, b_HELLO, a_1);	/* HELLO */
  ...
  private CobolDataStorage b_HELLO;	/* HELLO */
  ...
  /* PROGRAM-ID : HELLO */
  private AbstractCobolField f_HELLO;	/* HELLO */
